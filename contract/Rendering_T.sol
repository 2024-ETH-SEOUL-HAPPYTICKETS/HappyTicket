...
library NFTRenderer_T {
    using Strings for uint256;

    function render(RenderParams_T memory params) internal pure returns (string memory) {
    ...
    function generateSVG(RenderParams_T memory params) internal pure returns (string memory) {
